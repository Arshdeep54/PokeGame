...
export class TextBox {
  ...
  draw() {
    ...
    this.context.fillText(
      this.instruction,
      this.xpos + 20,
      this.ypos + this.height - 20
    );
    // if (this.inBattle&& this.battleStatus==null) {
    //   this.loadMoves();
    ...
    //   );
    // }
    // else if (this.inBattle && this.movedone&&this.battleStatus!=null) {
            ...
            if (!this.battledone) {
                ...
                if (this.showBattleOptions && !this.movedone) {
                    ...
                    if (smove.option != ".....") {
                        ...
                        this.chosenText = this.battleStatus==null?"You chose " + this.selectedMove.move:" "
